program optimization 
    ...
    ! - there are two options for finite difference: five-point or two-point
        !- five point is capable of different step sizes for each independent variable. 
    ! - change step sizes for finite difference, if necessary 
    ...
    integer, parameter :: numberOfIterations = 15, numberOfConfig = 20, numberOfParticles = 2     ! number of iterations and number of configurations 
    ...
    integer, parameter :: intervalForThermals = 300 ! interval for the next thermalisation 
    integer :: iseed 


    ! optimization related 
    real(rn), dimension(numberOfParams) :: parameterValues = [ 2.5918314992787819, 0.62554326201294441   ]  
    real(rn), parameter :: learning_rate=0.1, tolerance =0.000000000000001
    ...
    contains 
        ...
        real(rn), dimension(numberOfParams), parameter :: h = [0.01, 0.01] ! diff. size  for each coordinates
