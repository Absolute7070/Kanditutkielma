program optimization 
    ...
    ! version 1: thermalisation every optimization step 
    ...
    integer, parameter :: numberOfIterations = 10, numberOfConfig = 1000, numberOfParticles = 2     ! number of iterations and number of configurations 
    ...
    integer, parameter :: numberOfParallel = 23 ! number of cores to be used 
    integer :: iseed 
