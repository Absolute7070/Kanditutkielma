program main
    ...
    integer, parameter :: numberOfIterations = 5, numberOfConfig = 10, numberOfParticles = 2     ! number of iterations across whole configuration space and number of configurations 
    ...
    real(rn), dimension(numberOfParams) :: parameterValues = [1,2 ] 
    ...
    integer, parameter :: numberOfParallel = 5 ! number of parallel subconfiguration spaces for Metropolis
    integer :: iseed 
