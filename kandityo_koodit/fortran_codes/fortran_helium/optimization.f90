program optimization 
    ! version 0: thermalisation only once, then proceed to optimize
    ...
    integer, parameter :: numberOfIterations = 5, numberOfConfig = 100, numberOfParticles = 2     ! number of iterations and number of configurations 
    ...
    real(rn), dimension(numberOfParams) :: parameterValues = [1.0 ,2.0 ] 
    real(rn), parameter :: learning_rate= 0.1, tolerance = 0.000001
    integer, parameter :: maximumsteps = 200 
    ...
    ! gradient descent 
    call gradientdescentsub(learning_rate, samplesInConfigSubspace, parameterValues, tolerance, maximumsteps )
    ...
    contains 
        ...
        subroutine gradientdescentsub(learning_rate, configurationspace, params, tolerance, maximumsteps )
            ...
            counter = 0 
            DO WHILE (ANY( gradient > tolerance) )
                print '("Counter: ", i0, " Gradient: ")', counter 
                print*, gradient
                print*, '   Parameters: '
                print*, params
        ...
        function gradient_atapoint(configurationspace,  params)
            ...
            do i =1, numberOfParams
                 ...
                 gradient_atapoint(i ) = twoPointDiff(configurationspace, params, i )
            end do 
            !$OMP END DO 
